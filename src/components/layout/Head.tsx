...
export default function Example() {
  return (
    <Popover className="relative bg-white">
      <div className="px-4 mx-auto max-w-7xl sm:px-6">
        <div className="flex justify-between items-center py-6 border-b-2 border-gray-100 md:justify-start md:space-x-10">
            ...
            <Popover className="relative">
              {({ open }) => (
                <>
                  ...
                  >
                    <Popover.Panel className="absolute z-10 px-2 mt-3 -ml-4 w-screen max-w-md sm:px-0 lg:left-1/2 lg:ml-0 lg:-translate-x-1/2">
                      <div className="overflow-hidden rounded-lg ring-1 ring-black ring-opacity-5 shadow-lg">
                        <div className="grid relative gap-6 py-6 px-5 bg-white sm:gap-8 sm:p-8">
                          {solutions.map((item) => (
                            ...
                            >
                              <item.icon className="shrink-0 w-6 h-6 text-indigo-600" aria-hidden="true" />
                              <div className="ml-4">
                        ...
                        <div className="p-5 space-y-6 bg-gray-50 sm:flex sm:px-8 sm:space-y-0 sm:space-x-10">
                          {callsToAction.map((item) => (
                            <div key={item.name} className="flow-root">
                              <a
                                href={item.href}
                                className="flex items-center p-3 -m-3 text-base font-medium text-gray-900 hover:bg-gray-100 rounded-md"
                              >
                                <item.icon className="shrink-0 w-6 h-6 text-gray-400" aria-hidden="true" />
          ...
          <div className="hidden justify-end items-center md:flex md:flex-1 lg:w-0">
            <a href="#" className="text-base font-medium text-gray-500 hover:text-gray-900 whitespace-nowrap">
              Sign in
            </a>
            <a
              href="#"
              className="inline-flex justify-center items-center py-2 px-4 ml-8 text-base font-medium text-white whitespace-nowrap bg-indigo-600 hover:bg-indigo-700 rounded-md border border-transparent shadow-sm"
            >
              Sign up
            </a>
          </div>
      ...
      >
        <Popover.Panel focus className="absolute inset-x-0 top-0 p-2 transition origin-top-right md:hidden">
